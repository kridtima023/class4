        ...
        <div>
            <asp:FormView ID="FormView1" runat="server" DataSourceID="categoryDS">
                <EditItemTemplate>
                    ...
                    <br />
                    <asp:Button ID="UpdateButton" runat="server" CausesValidation="True" CommandName="Update" PostBackUrl="CategoryData.aspx" Text="Update" />
                    &nbsp;<asp:Button ID="UpdateCancelButton" runat="server" CausesValidation="False" CommandName="Cancel" PostBackUrl="CategoryData.aspx" Text="Cancel" />
                </EditItemTemplate>
                <InsertItemTemplate>
                    CategoryKey:
                    <asp:TextBox ID="CategoryKeyTextBox" runat="server" Text='<%# Bind("CategoryKey") %>' />
                    ...
                    <asp:TextBox ID="ModifyDateTextBox" runat="server" Text='<%# Bind("ModifyDate") %>' />
                    <br />
                    <asp:LinkButton ID="InsertButton" runat="server" CausesValidation="True" CommandName="Insert" PostBackUrl="CategoryData.aspx" Text="Edit" />
                    &nbsp;<asp:LinkButton ID="InsertCancelButton" runat="server" CausesValidation="False" CommandName="Cancel" PostBackUrl="CategoryData.aspx" Text="Cancel" />
                </InsertItemTemplate>
                <ItemTemplate>
                    CategoryKey:
