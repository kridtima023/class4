    ...
    <form id="form1" runat="server">
        <asp:FormView ID="FormView1" runat="server" DataSourceID="productDS">
            <EditItemTemplate>
                ...
                <br />
                <asp:Button ID="UpdateButton" runat="server" CausesValidation="True" CommandName="Update" PostBackUrl="ProductData.aspx" Text="Update" />
                &nbsp;<asp:Button ID="UpdateCancelButton" runat="server" CausesValidation="False" CommandName="Cancel" PostBackUrl="ProductData.aspx" Text="Cancel" />
            </EditItemTemplate>
            <InsertItemTemplate>
                ProductID:
                <asp:TextBox ID="ProductIDTextBox" runat="server" Text='<%# Bind("ProductID") %>' />
                ...
                <asp:TextBox ID="Barcode5TextBox" runat="server" Text='<%# Bind("Barcode5") %>' />
                <br />
                <asp:Button ID="InsertButton" runat="server" CausesValidation="True" CommandName="Insert" PostBackUrl="ProductData.aspx" Text="Insert" />
