        ...
        <div>
            <asp:FormView ID="FormView1" runat="server" DataSourceID="unitDS">
                <EditItemTemplate>
                    ...
                    <br />
                    <asp:Button ID="UpdateButton" runat="server" CausesValidation="True" CommandName="Update" PostBackUrl="UnitData.aspx" Text="Update" />
                ...
                <InsertItemTemplate>
                    ...
                    <asp:TextBox ID="ModifyDateTextBox" runat="server" Text='<%# Bind("ModifyDate") %>' />
                    <br />
                    <asp:Button ID="InsertButton" runat="server" CausesValidation="True" CommandName="Insert" PostBackUrl="UnitData.aspx" Text="Insert" />
                    &nbsp;<asp:Button ID="InsertCancelButton" runat="server" CausesValidation="False" CommandName="Cancel" PostBackUrl="UnitData.aspx" Text="Cancel" />
                </InsertItemTemplate>
                <ItemTemplate>
                    UnitKey:
